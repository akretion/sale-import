...
class SaleOrder(models.Model):
    ...
    def process_json_import(self, data, **kwargs):
        ...
        new_sale_order._si_finalize(data)
    ...
    def _si_process_dump(self, so_vals):
        """ Input: datamodel dump dict, transforms its values in-place
    ...
    def _si_process_addresses(self, partner_id, so_vals):
        ...
        for address_field in (
            ...
            version = self.env["res.partner"].find_or_create_version(addr)
    ...
    def _si_finalize(self, data):
        """ Overload this to complete the import """
        pass
